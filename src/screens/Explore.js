...
const cards = [ 
    ...
    { title: 'Game Developer', description: 'description', img: require('../assets/images/python.png') },
    { title: 'Cybersec Engineer', description: 'description', img: require('../assets/images/python.png') },
  ];
